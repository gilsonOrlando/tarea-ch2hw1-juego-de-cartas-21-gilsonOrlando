...
public class Carta {
    ...
    /*Crea un Joker, con 1 como el valor asociado. (Tenga en cuenta que"nueva Tarjeta ()"
      es equivalente a "nueva Tarjeta (1,Carta.joker)".)*/
    public Carta() {
        indumentaria = joker;
        valor = 1;
    }
    ...
    /*Crea una carta con un palo y valor especificados.
     ...
     Puede usar las constantes Carta.ACE, Carta.JACK, Carta.QUEEN y Carta.KING.  
     ...
     Carta.SPADES, Carta.HEARTS, Carta.DIAMONDS, Carta.CLUBS o Carta.JOKER.
     @throws IllegalArgumentException si los valores de los parámetros no están en el
     rangos permisibles*/
    public Carta(int elValor, int laIndumentaria) {
    ...
    /*Devuelve la indumentaruia de esta carta.
     devuelve el indumentaria, que es una de las constantes Carta.spadas, 
