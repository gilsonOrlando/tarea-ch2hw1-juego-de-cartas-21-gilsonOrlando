...
/*Un objeto de tipo Mano representa una mano de cartas las tarjetas pertenecen a la clase Carta. 
Una mano está vacía cuando se crea y se puede agregar cualquier cantidad de tarjetas.*/
public class Hand {

    private ArrayList<Carta> mano;// Las cartas que estaran en la mano.
