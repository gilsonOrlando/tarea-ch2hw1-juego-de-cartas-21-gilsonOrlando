...
public class BlackJack {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            JOptionPane.showMessageDialog(null,"Usted tiene: $" + dinero + "  para realizar apuestas");
            do {
                apuestas = Integer.parseInt(JOptionPane.showInputDialog(null,"Cuanto dinero desea apostar?(Ingrese 0 para finalizar)"));
 ...
 String cad="";
       ...
       El jugador con Blackjack gana el juego. El distribuidor gana lazos.*/
        if (manoDistribuidor.getValorBlackJack() == 21) {
            ...
            cad="El distribuidor tiene la " + manoDistribuidor.getCarta(0) + " y la " + manoDistribuidor.getCarta(1) + ".\n"+
        ...
        while (true) {
            ...
            if (accionUsuario == 'L') {
                ...
                Carta nuevaCarta = deck.cartadeOferta();
